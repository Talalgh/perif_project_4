...
foreach ($result as $row) {
    ...
    $insertQuery = "INSERT INTO cart (image, name, price, total, user_id) VALUES (:image, :name, :price, :total, '$iduser')";
    ...
    $insertStatement->bindParam(':total', $price);
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="hearer_icon d-flex">
                            ...
                            <div class="dropdown cart">
                                <a href="cart.php" id="navbarDropdown3" aria-expanded="false">
                    ...
                    <div class="left_sidebar_area">
                        ...
                        <aside class="left_widgets p_filter_widgets">
                            ...
                            <div class="widgets_inner">
                                ...
                                <div style="height: 180px; overflow-y: auto; overflow-x: hidden;">
                                    ...
                                    $query = "SELECT DISTINCT(car_brand) FROM cars WHERE product_status = '1' ORDER BY car_id DESC";
                                    $statement = $connect->prepare($query);
                                    $statement->execute();
                                    $result = $statement->fetchAll();
                                    foreach ($result as $row) {
                                    ?>
                                        <div class="list-group-item checkbox">
                                            <label><input type="checkbox" class="common_selector brand" value="<?php echo $row['car_brand']; ?>"> <?php echo $row['car_brand']; ?></label>
                                        </div>
                                    <?php
                                    }
                        ...
                        <aside class="left_widgets p_filter_widgets">
                            ...
                            <div class="widgets_inner">
                                ...
                                $query = " SELECT DISTINCT(car_color) FROM cars WHERE product_status = '1' ORDER BY car_color DESC
                                    ";
                                $statement = $connect->prepare($query);
                                $statement->execute();
                                $result = $statement->fetchAll();
                                ...
                                ?>
                                    <div class="list-group-item checkbox">
                                        <label><input type="checkbox" class="common_selector ram" value="<?php echo $row['car_color']; ?>"> <?php echo $row['car_color']; ?> GB</label>
                                    </div>
                                <?php
                                }
